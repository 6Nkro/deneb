...
public interface BookDAO {
    ...
    @Insert("insert into book values (#{book_seq}, #{parent_bookcase_seq}, #{book_name}, #{book_color}, 'Y', '[]')")
   ...
   @Update("update book set book_name = #{book_name}, book_color = #{book_color} where book_seq = #{book_seq}")
