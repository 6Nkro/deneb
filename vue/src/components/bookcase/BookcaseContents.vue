...
import CreateBook from '@/components/bookcase/CreateBook'
import EditBook from '@/components/book/EditBook'
import MoveBook from '@/components/book/MoveBook'
import CreateBookmark from '@/components/book/CreateBookmark'
...
export default {
  ...
  components: { CreateBook, EditBook, MoveBook, CreateBookmark, EditBookmark, BookList },
  data () {
    return {
      createBook: false,
      editBook: false,
